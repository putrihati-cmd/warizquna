...
const STEPS = [
  {
    ...
    body: "Buat akun gratis tanpa kartu kredit. Anda langsung mendapatkan akses instan ke seluruh dashboard utama.",
    items: ["Pendaftaran kurang dari 1 menit", "Akses dashboard instan", "Siap menghubungkan perangkat"],
  },
  {
    n: 2,
    icon: Link2,
    ...
    items: ["Tutorial panduan langkah-demi-langkah", "Koneksi instan kurang dari 10 detik", "Status perangkat terhubung secara real-time"],
  },
  {
    n: 3,
    icon: Send,
    title: "Mulai Kirim Pesan",
    body: "Gunakan panel dashboard untuk mengirim pesan tes atau integrasikan REST API ke sistem / website internal Anda.",
    items: ["Kirim pesan tes via dashboard", "REST API sederhana & cepat", "Webhook real-time untuk event masuk"],
  },
  {
    n: 4,
    icon: BarChart3,
    title: "Monitor & Kelola",
    body: "Pantau log status pengiriman pesan, kelola API Key, Webhooks, dan database kontak pelanggan Anda.",
    items: ["Laporan status pengiriman pesan", "Audit log aktivitas keamanan akun", "Kelola API Key & Webhooks secara dinamis"],
  },
];
