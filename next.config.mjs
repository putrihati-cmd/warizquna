...
const securityHeaders = [
  ...
  // restrict scripts to self + analytics providers.
  {
    ...
    value: [
      ...
      "script-src 'self' 'unsafe-inline' https://plausible.io https://*.plausible.io https://www.googletagmanager.com https://static.cloudflareinsights.com",
      "connect-src 'self' ws: wss: https://plausible.io https://*.plausible.io https://www.google-analytics.com https://static.cloudflareinsights.com",
